...
<body>
 ...
 <div class="a1-container a1-small a1-padding-32" style="margin-top:3%; margin-bottom:2px;">
       ...
       <form id="form1" name="form1" method="post" class="a1-container" action="saveupdateebookdb.php">
         ...
         <tr>
           <td height="35"><table width="100%" border="0" align="center">
            ...
            <tr>
             ...
             <tr>
               <td height="35">&nbsp;</td>
               <td height="35"><input class="a1-btn a1-blue" type="submit" name="submit" id="submit" value="UPDATE EBOOK" >
