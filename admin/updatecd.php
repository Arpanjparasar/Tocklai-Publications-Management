...
<body>
 ...
 <div class="a1-container a1-small a1-padding-32" style="margin-top:3%; margin-bottom:2px;">
       ...
       <form id="form1" name="form1" method="post" class="a1-container" action="saveupdatecddb.php">
         <table width="100%" border="0" align="center">
         <tr>
           <td height="35"><table width="100%" border="0" align="center">
           	 <tr>
           	   <td height="35">VD NAME:</td>
           	   <td height="35"><input type='text' name="name" value="<?php echo $row['name']?>" size="30"></td>
         	   </tr>
            ...
            <tr>
             ...
             <tr>
               <td height="35">&nbsp;</td>
               <td height="35"><input class="a1-btn a1-blue" type="submit" name="submit" id="submit" value="UPDATE CD" >
