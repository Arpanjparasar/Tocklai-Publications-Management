...
<table border='1' align="center">
	...
	<?php
							...
							echo '<tr>
									...
									echo 	'<td><form action="process_del_book.php" method="GET"><input type="hidden" name="id" value='.$row['bid'].'><input type="image" src="images/drop.png" onclick="return ConfirmDelete()" ></form></td>
